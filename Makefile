# stapel-booking — docs/llms.txt emission + drift gate (contract-pipeline.md §2-3).
#
# docs/capabilities.json here is HAND-WRITTEN (authored in the stapel-catalog
# sweep, commit 7192633 "docs: author capabilities.json for the stapel-catalog
# sweep") — this composite preset mounts no urls and has no gate registry, no
# docs/schema.json, nothing for a codegen step to derive axes/surface from.
# The targets below manage ONLY the fifth contract artifact, docs/llms.txt
# (stapel_tools.llms_txt), rendered straight from that curated
# capabilities.json. They do NOT regenerate or touch capabilities.json itself
# — that stays hand-edited.
#
